...
class NOSActions extends React.Component {
  ...
  render() {
    ...
    // (test) Invoke
    const scriptHashNeoAuth = "7eb11b249065d011e73885e169f080070660448b";
    const operation = "deposit";
    const args = ['AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y',gas,'20'];
    ...
    return (
      <React.Fragment>
        <a className="btn-neoscan" onClick={this.handleGetAddress}>
          Get Address
        </a>
        <a className="btn-neoscan" onClick={() => this.handleGetBalance(neo)}>
          Get NEO Balance
        </a>
        ...
        */}
        <a className="btn-neoscan" onClick={this.handleClaimGas}>
          Claim Gas
        </a>


        <a
          className="btn-neoscan"
